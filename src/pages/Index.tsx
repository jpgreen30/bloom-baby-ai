        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-primary-foreground">
          <div className="max-w-4xl mx-auto space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold animate-fade-in">
              AI-Powered Baby Development Tracking
            </h1>
            
            <p className="text-lg md:text-2xl opacity-90 max-w-3xl mx-auto">
              Track every milestone, predict what's next, and get personalized guidance for your baby's journey
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm pt-6">
